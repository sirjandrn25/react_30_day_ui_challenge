...
import HeaderFooter from './challenges/day6/HeaderFooter'
import { ColorsIconsProvider } from './challenges/day6/context'
  ...
  <React.StrictMode>
    <BrowserRouter>
      <Routes>
        ...
        <Route path='*' element={<main>HTTP404 Error</main>} />
      </Routes>
    </BrowserRouter>
  </React.StrictMode>
)
